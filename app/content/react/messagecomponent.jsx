...
class MessageComponent extends React.Component{
  ...
  componentWillMount() {
    this.setState( {userColor: this.props.nameToColor(this.props.sender)} );
  }

  componentDidMount() {
    if (this.props.messageOwner)
         TweenLite.fromTo(this.message, 0.3, {x: 300}, {x: 0} );
    else TweenLite.fromTo(this.message, 0.3, {x: -300},{x: 0} );
    // if (this.props.messageOwner){
